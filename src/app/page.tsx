  ...
  const projects = [
    {
      ...
      description: "Built intelligent document Q&A system using RAG architecture. Implemented custom text chunking algorithms, OpenAI embeddings for semantic search, Pinecone vector database for similarity matching, and GPT-4 integration for contextual responses. Features real-time PDF processing, conversation memory, and optimized retrieval scoring.",
      link: "https://github.com/yourusername/pdf-rag-chatbot"
    },
    {
      year: "2022",
      ...
      <div className="flex-1 flex items-start" style={{ minHeight: "100vh" }}>
        ...
        >
          ...
          <div className="text-left max-w-2xl px-6" style={{ marginLeft: "10vw" }}>
            ...
            {/* Projects Section */}
            <div className={`mt-35 transition-opacity duration-1000 ${showProjects ? 'opacity-100' : 'opacity-0'}`}>
              ...
              {projects.map((project, index) => (
                ...
                >
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-base md:text-lg font-light hover:opacity-80 transition-opacity duration-200 underline"
                  >
                    GitHub
                  </a>
